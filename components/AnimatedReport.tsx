...
import animatedReportData from '../animated-report.json';

interface AnimatedReportProps {
  className?: string;
}

export default function AnimatedReport({ className = '' }: AnimatedReportProps) {
  ...
  useEffect(() => {
    ...
    const animation = lottie.loadAnimation({
      ...
      loop: true,
      autoplay: true,
      animationData: animatedReportData,
      rendererSettings: {
