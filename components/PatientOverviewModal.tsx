...
const TOOTH_STATE_LABELS: Record<string, { label: string; color: string }> = {
  ...
  endodoncia_con_restauracion: { label: 'Endodoncia con Restauración', color: 'bg-orange-100 text-orange-700' },
  endodoncia_con_caries: { label: 'Endodoncia con Caries', color: 'bg-orange-200 text-orange-800' },
  endodoncia_con_corona: { label: 'Endodoncia con Corona', color: 'bg-amber-200 text-amber-800' },
  endodoncia_abierta: { label: 'Endodoncia Abierta', color: 'bg-amber-300 text-amber-900' },
  endodoncia_con_provisional: { label: 'Endodoncia con Provisional', color: 'bg-amber-100 text-amber-800' },
  ...
  carilla_resina: { label: 'Carilla de Resina', color: 'bg-teal-200 text-teal-800' },
  carilla_defectuosa: { label: 'Carilla Defectuosa', color: 'bg-red-200 text-red-800' },
  carilla_disilicato: { label: 'Carilla de Disilicato', color: 'bg-slate-200 text-slate-700' },
