...
import animatedUserData from '../animated-user.json';

interface AnimatedUserProps {
  className?: string;
}

export default function AnimatedUser({ className = '' }: AnimatedUserProps) {
  ...
  useEffect(() => {
    ...
    const animation = lottie.loadAnimation({
      ...
      loop: true,
      autoplay: true,
      animationData: animatedUserData,
      rendererSettings: {
    ...
    animation.addEventListener('DOMLoaded', () => {
      ...
      if (svgElement) {
        ...
        style.textContent = `
          svg[data-user-animation] * {
            fill: #ffffff !important;
            stroke: #ffffff !important;
            color: #ffffff !important;
          }
        `;
        svgElement.setAttribute('data-user-animation', 'true');
