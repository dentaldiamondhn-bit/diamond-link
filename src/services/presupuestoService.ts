...
const ESTADO_COLORS: { [key: string]: { label: string; color: string } } = {
  ...
  carilla_resina: { label: 'Carilla de Resina', color: '#4DD0E1' },
  carilla_defectuosa: { label: 'Carilla Defectuosa', color: '#E57373' },
  carilla_disilicato: { label: 'Carilla de Disilicato', color: '#B0BEC5' },
