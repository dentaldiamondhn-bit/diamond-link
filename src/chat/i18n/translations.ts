...
const en = {
  ...
  selectConversationHint: 'Choose a conversation from the sidebar or start a new one',
...
const es: Record<keyof typeof en, string> = {
  ...
  selectConversationHint: 'Elige una conversación del panel lateral o inicia una nueva',
