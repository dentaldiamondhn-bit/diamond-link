...
const en = {
  ...
  notificationsDesc: 'Get push notifications for new messages on this device.',
  notificationsEnable: 'Enable notifications',
  notificationsDisable: 'Disable notifications',
  notificationsEnabledLabel: 'Enabled on this device',
  notificationsDisabledLabel: 'Off on this device',
  notificationsDeniedLabel: 'Blocked in browser settings',
  notificationsUnsupportedLabel: 'Not supported on this device',
  notificationsEnableHint: "You'll receive chat messages even when the app is closed.",
  notificationsEnabledHint: 'Check your device notification settings to adjust sound and previews.',
  notificationsTest: 'Send test notification',
  notificationsTestOk: 'Test notification sent!',
...
const es: Record<keyof typeof en, string> = {
  ...
  notificationsDesc: 'Recibe notificaciones push por los mensajes nuevos en este dispositivo.',
  notificationsEnable: 'Activar notificaciones',
  notificationsDisable: 'Desactivar notificaciones',
  notificationsEnabledLabel: 'Activadas en este dispositivo',
  notificationsDisabledLabel: 'Desactivadas en este dispositivo',
  notificationsDeniedLabel: 'Bloqueadas en la configuración del navegador',
  notificationsUnsupportedLabel: 'No soportado en este dispositivo',
  notificationsEnableHint: 'Recibirás los mensajes del chat aunque la app esté cerrada.',
  notificationsEnabledHint: 'Revisa los ajustes de notificación del dispositivo para el sonido y las vistas previas.',
  notificationsTest: 'Enviar notificación de prueba',
  notificationsTestOk: '¡Notificación de prueba enviada!',
  notificationsBusy: 'Trabajando…',
};
