...
3. Que entiendo que los tratamientos pueden requerir varias citas y que seguiré las indicaciones dadas por el profesional antes, durante y después de cada procedimiento, incluyendo las farmacológicas. 
4. Que se me ha explicado que los tratamientos tienen un costo previamente informado y que será cubierto antes de su realización. 
5. Que otorgo mi confianza al profesional tratante y autorizo la realización de los procedimientos necesarios para la atención odontopediátrica de mi representado.`
  }
];
