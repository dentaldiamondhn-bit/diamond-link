-- Comprehensive Chat System for Dental Diamond Link
-- Supports: Direct messages, group chats, file sharing, patient case attachments
...
-- Create chat attachments table for file sharing
...
-- Create patient case links table
...
-- RLS Policies for chat_patient_case_links
