  ...
  try {
    ...
    const tempPatientData: Omit<Patient, 'paciente_id'> = {
      nombre_completo: formData.get('nombre_completo') as string,
        ...
        rep_tipo_identificacion: formData.get('rep_tipo_identificacion') as Patient['rep_tipo_identificacion'] || undefined,
        rep_otro_tipo_identificacion: formData.get('rep_otro_tipo_identificacion') as string || undefined,
        ...
        reaccion_adversa_anestesico: formData.get('reaccion_adversa_anestesico') as Patient['reaccion_adversa_anestesico'],
